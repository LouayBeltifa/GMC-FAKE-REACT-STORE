...
const products = [
  ...
  },
  {
    ...
    description: "Adjustable mesh chair with lumbar support and 360° rotation.",
    price: 149.99,
    category: "Furniture",
    stock: 20,
    rating: 4.7,
    ...
    <main className="flex bg-white p-10">
      ...
      <div className="w-1/2 flex flex-col gap-4">
        ...
        <div className="flex w-full gap-5 mt-10">
          ...
          <button
            className="bg-emerald-400 p-2 px-4 rounded-xl cursor-pointer border-0 font-medium hover:bg-emerald-500 hover:text-white transition-all"
            onClick={() => {
              dispatch(addToCart({ ...currentProduct, quantity: quantite }));
          ...
          <button
            ...
            onClick={() => {
              if (isFavourite) {
                dispatch(removeFromFavourites(currentProduct.id));
